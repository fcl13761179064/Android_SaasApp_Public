...
public class RemoteSceneIconSelectDialog extends Dialog {
    private final List<CheckBox> checkBoxes = new ArrayList<>();
    private final List<View> rlLayouts = new ArrayList<>();
    int index = 0;

    public RemoteSceneIconSelectDialog(@NonNull Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_scene_icon_select, null);
        ...
        if (window != null) {
            ...
            lp.windowAnimations = R.style.main_menu_animstyle;
