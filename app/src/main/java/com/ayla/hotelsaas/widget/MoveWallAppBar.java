...
public class MoveWallAppBar extends FrameLayout {
    ...
    public MoveWallAppBar(@NonNull Context context) {
        this(context, null);
    }

    public MoveWallAppBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MoveWallAppBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        inflate(getContext(), R.layout.move_wall_layout, this);
