...
public class Programe_change_AppBar extends FrameLayout {
    ...
    public Programe_change_AppBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Programe_change_AppBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        inflate(getContext(), R.layout.change_project_appbar_layout, this);
