...
public abstract class BaseSceneBean implements Serializable {
    ...
    public static class DeviceCondition extends Condition {
        ...
        public boolean isRadioProperty() {
            return radioProperty;
        }

        public void setRadioProperty(boolean radioProperty) {
    ...
    public static class GroupAction extends Action implements Serializable {
    ...
    public static class TTSAction extends Action implements Serializable {
