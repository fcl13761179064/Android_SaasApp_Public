...
public class ProjectListTabAdapter extends CommonNavigatorAdapter {
    ...
    public ProjectListTabAdapter(List<String> titles, ViewPager viewPager, MagicIndicator magicIndicator) {
        this.titles = titles;
