...
public class DistributionRoomAdapter extends BaseQuickAdapter<CheckableSupport<RoomManageBean.RecordsBean>, BaseViewHolder> {
    public DistributionRoomAdapter(@Nullable List data) {
        super(data);
