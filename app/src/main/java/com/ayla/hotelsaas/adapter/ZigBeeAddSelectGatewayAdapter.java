...
public class ZigBeeAddSelectGatewayAdapter extends BaseQuickAdapter<DeviceListBean.DevicesBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, DeviceListBean.DevicesBean item) {
        ...
        helper.setBackgroundRes(R.id.v_device_online_status_dot, TempUtils.isDeviceOnline(item) ? R.drawable.ic_device_online : R.drawable.ic_device_offline);
        helper.setText(R.id.tv_device_online_status, TempUtils.isDeviceOnline(item) ? "在线" : "离线");
