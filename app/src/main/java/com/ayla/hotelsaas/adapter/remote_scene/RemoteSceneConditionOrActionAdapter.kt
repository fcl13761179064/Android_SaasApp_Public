package com.ayla.hotelsaas.adapter.remote_scene
...
data class SceneConditionOrActionItem(
...
class RemoteSceneConditionOrActionAdapter :
    BaseItemDraggableAdapter<SceneConditionOrActionItem, BaseViewHolder>(
        R.layout.item_remote_scene_item,
        null
    ) {
    ...
    override fun convert(helper: BaseViewHolder?, item: SceneConditionOrActionItem?) {
        helper?.apply {
    ...
    private fun setValue(
        ...
        if (devicesBean != null) {
            ...
            helper.setText(R.id.item_local_scene_name, "XXX-000-000")
