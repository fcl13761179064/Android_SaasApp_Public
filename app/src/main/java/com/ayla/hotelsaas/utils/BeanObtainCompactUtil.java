            ...
            if (ruleEngineBean.getAction() != null) {
                if (ruleEngineBean.getAction().getItems() != null) {
                    for (RuleEngineBean.Action.ActionItem actionItem : ruleEngineBean.getAction().getItems()) {
                        ...
                        } else if (actionItem.getTargetDeviceType() == DeviceType.GROUP_ACTION) {//普通设备动作
                            action = new BaseSceneBean.GroupAction();
                        } else if (TextUtils.equals(actionItem.getLeftValue(), ConstantValue.TTS_LEFT_VALUE)) {
                            action = new BaseSceneBean.TTSAction();
                        } else {
