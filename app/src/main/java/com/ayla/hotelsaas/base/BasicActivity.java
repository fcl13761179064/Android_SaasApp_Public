 ...
 public  abstract class BasicActivity extends AppCompatActivity {
    ...
    private void initAppbar() {
        ...
        if (appbarRoot != null) {
            ...
            View add_scene_btn = appbarRoot.findViewById(R.id.add_scene_btn);
            if (add_scene_btn != null && !add_scene_btn.hasOnClickListeners()) {
                add_scene_btn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        appBarAddSceneRuleBtn();
                    }
                });
            }
    ...
    protected void appBarAddSceneRuleBtn() {
