            ...
            public void onClick(View v) {
                ...
                ValueChangeDialog
                        .newInstance(new ValueChangeDialog.DoneCallback() {
                            ...
                            public void onDone(DialogFragment dialog, String txt) {
                                if (TextUtils.isEmpty(txt) || txt.trim().isEmpty()) {
                                    CustomToast.makeText(getBaseContext(), "设备点位不能为空", R.drawable.ic_toast_warning);
                                    return;
                                }
        ...
        binding.btBind.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(newNickname) || newNickname.trim().isEmpty()) {
                    CustomToast.makeText(MyApplication.getContext(), "设备名称不能为空", R.drawable.ic_toast_warning);
                    return;
                }
                ...
                if (TextUtils.isEmpty(newLocationName) || newLocationName.trim().isEmpty()) {
                    CustomToast.makeText(MyApplication.getContext(), "设备点位不能为空", R.drawable.ic_toast_warning);
                    return;
                }
