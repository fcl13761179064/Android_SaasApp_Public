...
public abstract class BaseWebViewActivity extends BaseMvpActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.getSettings().setCacheMode(ConstantValue.isNetworkDebug() ? WebSettings.LOAD_NO_CACHE : WebSettings.LOAD_DEFAULT);
        ...
        WebView.setWebContentsDebuggingEnabled(CommonUtils.INSTANCE.isOpenLog());
    }
