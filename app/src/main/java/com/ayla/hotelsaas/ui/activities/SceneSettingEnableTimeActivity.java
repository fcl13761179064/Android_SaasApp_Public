...
import com.ayla.hotelsaas.ui.activities.set_scene.SceneSettingRepeatDataActivity;
import com.ayla.hotelsaas.utils.CustomToast;
import com.ayla.hotelsaas.widget.common_dialog.TimePickerDialog;
...
/**
 * 场景设置生效时间段
 * 进入时，带上enableTime {@link com.ayla.hotelsaas.bean.scene_bean.BaseSceneBean.EnableTime}
 * 返回时，带上新的 enableTime {@link com.ayla.hotelsaas.bean.scene_bean.BaseSceneBean.EnableTime}
 */
    ...
    protected void appBarRightTvClicked() {
        ...
        if (!enableTime.isAllDay()) {
            if (enableTime.getStartHour() > enableTime.getEndHour()) {
                CustomToast.makeText(this, "时间范围不能跨天", R.drawable.ic_toast_warning);
                return;
            }
