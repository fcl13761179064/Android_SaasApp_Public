...
import com.ayla.hotelsaas.mvp.present.HongYanZigBeeAddPresenter;
 ...
 */
public class HongYanZigBeeAddActivity extends BaseMvpActivity<HongYanZigBeeAddView, HongYanZigBeeAddPresenter> implements HongYanZigBeeAddView {
    private static final String TAG = "HYZigBeeAddActivity";
    @BindView(R.id.iv_01)
    ...
    @Override
    protected HongYanZigBeeAddPresenter initPresenter() {
        return new HongYanZigBeeAddPresenter();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_hongyan_zigbee_add;
    }
