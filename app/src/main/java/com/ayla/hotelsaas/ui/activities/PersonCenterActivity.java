...
public class PersonCenterActivity extends BaseMvpActivity<PersonCenterView, PersonCenterPresenter> implements PersonCenterView {
    ...
    protected void initView() {
        ...
        tv_version_code.setText(String.format("Version:%s", BuildConfig.VERSION_NAME));
        mPresenter.getUserInfo();
    }

    private void handleVersionTip() {
        VersionUpgradeBean versionUpgradeInfo = CommonUtils.INSTANCE.getVersionUpgradeInfo();
                ...
                CustomAlarmDialog
                        .newInstance(new CustomAlarmDialog.Callback() {
                            ...
                            public void onDone(CustomAlarmDialog dialog) {
                                ...
                                SharePreferenceUtils.remove(PersonCenterActivity.this, ConstantValue.SP_Login_Token);
                                SharePreferenceUtils.remove(PersonCenterActivity.this, ConstantValue.SP_Refresh_Token);
    ...
    public void onVersionResult(VersionUpgradeBean baseResult) {
        CommonUtils.INSTANCE.saveVersionUpgradeInfo(baseResult);
        handleVersionTip();
        if (baseResult != null) {
            UpgradeUnifiedCode.handleUpgrade(this, baseResult);
        } else {
            CustomToast.makeText(this, "当前已是最新版本", R.drawable.ic_toast_warning);
        }
    }
