...
//                                                  CustomToast.makeText(getApplicationContext(), "你拒绝了访问位置信息的授权，无法自动填充WiFi名称", R.drawable.ic_warning);
    ...
    public void handleJump() {
        ...
        if (name.length() == 0) {
            CustomToast.makeText(AylaWiFiAddInputActivity.this, "请输入WIFI名称", R.drawable.ic_toast_warning);
            return;
        }
        WifiUtils wifiUtil = WifiUtils.getInstance(this);
        ...
        if (scanResultList != null && scanResultList.size() > 0) {
            ...
            if (is_2g) {
                ...
                CustomToast.makeText(AylaWiFiAddInputActivity.this, "当前WiFi只支持2.4GWiFi", R.drawable.ic_toast_warning);
            }
        } else {
            CustomAlarmDialog
