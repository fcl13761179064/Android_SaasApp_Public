 ...
 * <p>
 * <p>
 * action {@link com.ayla.hotelsaas.bean.scene_bean.BaseSceneBean.DeviceAction} 正在编辑的action ，如果为null，就是新创建。
 */
public class SceneSettingDeviceSelectActivitys extends BaseMvpActivity<SceneSettingDeviceSelectView, SceneSettingDeviceSelectPresenter> implements SceneSettingDeviceSelectView {
    @BindView(R.id.rv)
    ...
    private void jumpNext(DeviceListBean.DevicesBean deviceBean) {
        Intent mainActivity = new Intent(SceneSettingDeviceSelectActivitys.this, SceneSettingFunctionSelectActivity.class);
