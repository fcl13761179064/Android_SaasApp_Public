...
public class DeviceAddBusiness {
     ...
     */
    public void filterDevice(final List<FoundDeviceListItem> foundDeviceListItems) {
        Log.d(TAG, "--find Data--" + JSON.toJSONString(localFoundDevice));
        ...
        Log.d(TAG, "--Data--" + JSON.toJSONString(localFoundDevice));
