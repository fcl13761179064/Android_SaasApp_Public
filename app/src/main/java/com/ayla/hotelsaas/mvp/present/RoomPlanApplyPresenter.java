...
public class RoomPlanApplyPresenter extends BasePresenter<RoomPlanApplyView> {
    ...
    public void showRoomType(long scopeId) {
        Disposable subscribe = RequestModel.getInstance()
                .showRoomType(scopeId)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .doOnSubscribe(new Consumer<Disposable>() {
                    @Override
                ...
                .subscribe(new Consumer<RoomTypeShowBean>() {
                    @Override
                    public void accept(RoomTypeShowBean o) throws Exception {
                        mView.showRoomTypeSuccess(o);
                    }
                }, new Consumer<Throwable>() {
                    @Override
                    public void accept(Throwable throwable) throws Exception {
